...
function Level_1 () {
    ...
    music.stopAllSounds()
    music.play(music.createSong(assets.song`Abandoned`), music.PlaybackMode.LoopingInBackground)
...
function Game_1_Player_Continued () {
    ...
    music.stopAllSounds()
    music.play(music.createSong(assets.song`Telporting`), music.PlaybackMode.LoopingInBackground)
...
function Game_1_Player () {
    ...
    story.startCutscene(function () {
        music.play(music.createSong(assets.song`Lead Rocker`), music.PlaybackMode.LoopingInBackground)
...
color.startFade(color.Black, color.originalPalette, 500)
music.play(music.createSong(assets.song`Chromatic Scale`), music.PlaybackMode.InBackground)
pause(1100)
